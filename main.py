...
from customer import customer_breakdown as cb, modify_account_details as ad
...
def main():
    ...
    while True:
        ...
        if initial_start == 1:
            ...
            transactions = gt(zip_code,month,year,transaction_type,state)
            print(transactions)
            if transactions:
                print('***************************************************************************TRANSACTIONS*****************************************************************************')
            ...
            if first_name !='q' or first_name != '':
                ...
                if decision == 1:
                    acct_details = cb(first_name,middle_name,last_name)
